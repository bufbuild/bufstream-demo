...
2. If you have Go installed, run `make iceberg-produce-run` in a new terminal to create sample data. If you don't have Go installed, use `make-iceberg-produce-run-docker`. Once you've produced about 1,000 records, stop the process.
